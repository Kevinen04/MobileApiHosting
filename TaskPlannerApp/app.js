...
addButton.addEventListener('click', () => {
  ...
  if (!nameValue || nameValue.trim() === '' || (!priorityValue && priorityValue !== 0) || isNaN(priorityValue)) {
    showAlert('Blank fields', 'All Fields should be filled');
    return;
  }

  if (priorityValue > 3 || priorityValue < 1) {
    showAlert('Invalid priority', 'The number should be between 1 and 3');
    priorityInput.value = '';
    return;
  }
